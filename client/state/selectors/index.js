...
export getPostRevisionsCompareFromPostId from './get-post-revisions-compare-from-post-id';
export getPostRevisionsCompareToPostId from './get-post-revisions-compare-to-post-id';
...
export isPostRevisionsDiffVisible from './is-post-revisions-diff-visible';
...
export isSitePressable from './is-site-pressable';
...
export isUpdatingJetpackCredentials from './is-updating-jetpack-credentials';
